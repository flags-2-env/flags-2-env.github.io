# flags-2-env.github.io

The public Astro marketing site for **flags-2-env**.

Typed executable configuration contracts for flags, environment keys, defaults, aliases, and precedence.
